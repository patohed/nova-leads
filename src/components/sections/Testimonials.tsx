  ...
  const testimonials = [
    {
      ...
      content: "NovaLeads transformó completamente nuestro proceso de generación de leads. En solo 3 meses aumentamos nuestras ventas en 280% y el ROI superó todas las expectativas. La atención personalizada es excepcional.",
      avatar: "MF",
      rating: 5,
    ...
    },
    {
      ...
      content: "La metodología de NovaLeads es excepcional. Su enfoque basado en datos nos ayudó a identificar oportunidades que nunca habríamos visto. Resultados desde la primera semana, equipo muy profesional.",
      avatar: "CM",
      rating: 5,
